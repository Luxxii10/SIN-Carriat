...
class LED():
    def __init__(self, led_pin_number):
        ...
        Args:
            led_pin_number (int):  1, 2, for onboard LED,
                                      and pass GPIOs number for interfacing external LED
...
class RELAY():
    def __init__(self, relay_pin_number):
        ...
        Args:
            relay_pin_number (int):  1, 2, for onboard Relay,
                                      and pass GPIOs number for interfacing external Relay
...
class BUZZER():
    def __init__(self, pin=22):
        ...
        Args:
            pin (int optional):  default GPIO - 22, only if interfacing external buzzer on other GPIOs
